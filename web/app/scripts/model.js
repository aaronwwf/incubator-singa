...
(function(){
  ...
  function filedBindation(container,controlField,fieldGroup){
  ...
  LayerProtoObj.additionBind=function(container){
    ...
    filedBindation(container,"type",fieldGroup);
  ...
  UpdaterProtoObj.additionBind=function(container){
    ...
    filedBindation(container,"type",fieldGroup1);

    filedBindation(container,"lr_change",fieldGroup2);
